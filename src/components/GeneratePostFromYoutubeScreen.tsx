...
interface GeneratePostFromYoutubeScreenProps {
  onBack: () => void;
}

const GeneratePostFromYoutubeScreen: React.FC<GeneratePostFromYoutubeScreenProps> = ({ onBack }) => {
  const [selectedFormat, setSelectedFormat] = useState('post-formats');
  const [youtubeUrl, setYoutubeUrl] = useState('https://www.youtube.com/watch?v=FUHkTs-lpfg');
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex items-center mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Generate a post from a Youtube video</h1>
          <p className="text-gray-600">Share a Youtube video link and generate a post from it</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        ...
        <div className="mb-8">
          ...
          <input
            ...
            placeholder="https://www.youtube.com/watch?v=FUHkTs-lpfg"
...
export default GeneratePostFromYoutubeScreen;